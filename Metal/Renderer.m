...
-(nonnull instancetype)initWithMetalKitView:( nonnull CAMetalLayer* )layer;
{
    self = [super init];
    if(self)
    {
...
- (void)_loadMetalWithView:(nonnull CAMetalLayer* )layer;
{
    /// Load Metal state objects and initalize renderer dependent view properties

    layer.depthStencilPixelFormat = MTLPixelFormatDepth32Float_Stencil8;
